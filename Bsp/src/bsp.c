...
{
    // å‡è®¾ä½ åœ¨ TIM6 ä¸­æ–­é‡Œå·²ç»æœ‰ time_10ms_f æ ‡å¿—
    // å¦‚æœæ˜¯ 100ms/200ms è¿™ç§å¤§å»¶æ—¶ï¼Œç›´æ¥åˆ¤æ–­æ ‡å¿—ä½æ˜¯æœ€å®‰å…¨çš„
    ...
    while (count < target_10ms_units)
    {
        ...
        // è£¸æœºè¿è¡Œï¼Œè¿™é‡Œå¯ä»¥é¡ºä¾¿å–‚ç‹—
        // IWDG_ReloadCounter(); 
    }
}
...
//		 }
		...
		Fan_Current_Det();  
		//USART1_Send_DisplayData();  // å¤–æ¥æ˜¾ç¤ºæ¿é€šä¿¡
...
**/
/*---------------------------------------------------------------------------------
---º¯ Êı Ãû£º-Task_beep_called_100ms
---¹¦    ÄÜ£º- 
---²Î    Êı£º- 
---·µ »Ø Öµ£º-
