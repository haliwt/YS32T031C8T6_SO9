...
#define KEY_TICKS_SHORT    4    // 40ms Ê∂àÊäñ
#define KEY_TICKS_LONG_P   250  // 2.5s ÁîµÊ∫êÈîÆÈïøÊåâ
#define KEY_TICKS_LONG_M   200  // 2s Ê®°Âºè/‰∏ãÈîÆÈïøÊåâ
...
volatile uint8_t beep_times;				//¥Œ ˝
volatile uint8_t beep_lenght;			  //œÏµƒ≥§∂» *100ms
volatile uint8_t non_beep_length;		//º‰∏Ù ±º‰
