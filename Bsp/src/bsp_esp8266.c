	...
	break;
	 ...
	 case wifi_set_cwmode:
		   ...
		   USART2_DMA_Send((uint8_t*)"AT+CWMODE=3\r\n", strlen("AT+CWMODE=3\r\n"));
        	 delay_ms(pdMS_TO_TICKS(1000));//HAL_Delay(1000);
